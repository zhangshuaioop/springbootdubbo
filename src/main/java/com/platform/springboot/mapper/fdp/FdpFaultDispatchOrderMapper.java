...
public interface FdpFaultDispatchOrderMapper {
    ...
    List<GetDispatchOrderListResp> getOrderListByObject(GetDispatchOrderListRequest record);
    ...
    List<FdpFaultDispatchOrderList> selectDispatchOrderList(GetFdpFaultdispatchOrderList getFdpFaultdispatchOrderList);
