...
/**
 * @author zhanghao
 * @Title: BifDispatchHumanResource
 * @ProjectName BlueOcean
 * @Description: 人力服务商
 * @date 2018/12/28上午11:47
 */
public class BifDispatchHumanResource extends BaseEntity {
    ...
    public String toString() {
        return "BifDispatchHumanResource{" +
                "id=" + id +
                ", account='" + account + '\'' +
                ", password='" + password + '\'' +
                ", nickname='" + nickname + '\'' +
                ...
                ", dispatchSuccessfulCount=" + dispatchSuccessfulCount +
                ", dispatchAvgFee=" + dispatchAvgFee +
                ", dispatchTotalFee=" + dispatchTotalFee +
                ", dispatchMaxFee=" + dispatchMaxFee +
                ...
                ", contactAssessmentCount=" + contactAssessmentCount +
                ", clientAssessmentCount=" + clientAssessmentCount +
                ", userAssmAchieveTotalPoint=" + userAssmAchieveTotalPoint +
                ", userAssmCommunicationTotalPoint=" + userAssmCommunicationTotalPoint +
                ", userAssmTimelyTotalPoint=" + userAssmTimelyTotalPoint +
                ", userAssmAchieveAvgPoint=" + userAssmAchieveAvgPoint +
                ", userAssmCommunicationAvgPoint=" + userAssmCommunicationAvgPoint +
                ", userAssmTimelyAvgPoint=" + userAssmTimelyAvgPoint +
                ", clientAssmAchieveTotalPoint=" + clientAssmAchieveTotalPoint +
                ", clientAssmCommunicationTotalPoint=" + clientAssmCommunicationTotalPoint +
                ", clientAssmTimelyTotalPoint=" + clientAssmTimelyTotalPoint +
                ", clientAssmAchieveAvgPoint=" + clientAssmAchieveAvgPoint +
                ", clientAssmCommunicationAvgPoint=" + clientAssmCommunicationAvgPoint +
                ", clientAssmTimelyAvgPoint=" + clientAssmTimelyAvgPoint +
                ", contactAssmTotalPoint=" + contactAssmTotalPoint +
                ", contactAssmAvgPoint='" + contactAssmAvgPoint + '\'' +
