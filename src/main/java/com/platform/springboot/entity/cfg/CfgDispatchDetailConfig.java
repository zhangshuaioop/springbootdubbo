...
public class CfgDispatchDetailConfig extends BaseEntity {
    ...
    private List<CfgDispatchDetailConfig> childList;

    public List<CfgDispatchDetailConfig> getChildList() {
        return childList;
    }

    public void setChildList(List<CfgDispatchDetailConfig> childList) {
