...
public class SysCompanyUsersService extends BaseService<SysCompanyUsersMapper,SysCompanyUsers> {
    ...
    public Result findUserView() {
        ...
        logger.info("查询当前关联公司，入参：relationCompanyIds="+sysCompanyUsers.getRelationCompanyIds());
        List<DmiCompanyInfo> dmiCompanyInfos = dmiCompanyInfoMapper.companyByUserList(sysCompanyUsers.getRelationCompanyIds());
