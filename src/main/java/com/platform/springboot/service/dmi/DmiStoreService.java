...
import com.platform.springboot.Thread.ImportStoreThread;
...
import com.platform.springboot.entity.dmi.ret.dmiStore.IndieProductInfo;
import com.platform.springboot.entity.dmi.ret.dmiStore.ListRet;
import com.platform.springboot.entity.file.DeleteFile;
...
import com.platform.springboot.mapper.dmi.DmiDeviceAssignMapper;
import com.platform.springboot.mapper.dmi.DmiStoreMapper;
import com.platform.springboot.mapper.dmi.DmiStoreUploadFileMapper;
import com.platform.springboot.mapper.trc.TrcDmiBatchEmpolyeeImportMapper;
...
public class DmiStoreService extends CommonBiz{
    ...
    public Result storeList(DmiStore store) {
        ...
        map.put("province",store.getProvince().equals("") ? null : store.getProvince());
        map.put("city",store.getCity().equals("") ? null : store.getCity());
        map.put("district",store.getDistrict().equals("") ? null : store.getDistrict());
     ...
     * @return
     */
    public Result storeListByCompanyId(Integer companyId) {
        List<DmiStore> dmiStores =  dmiStoreMapper.queryStoreByCompanyId(companyId);
