...
public class CfgDispatchModelConfigService{
    ...
    public Result list(CfgDispatchModelConfigParam cfgDispatchModelConfigParam) {
        ...
        cfgDispatchModelConfigParam.setCreatePerson(cfgDispatchModelConfigParam.getCreatePerson());
        cfgDispatchModelConfigParam.setUserId(user.getId());
    ...
    public Result show(int id) {
        CfgDispatchModelConfigShow show = new CfgDispatchModelConfigShow();
        CfgDispatchModelConfigShow result = mapper.show(id);
        if(result != null){
