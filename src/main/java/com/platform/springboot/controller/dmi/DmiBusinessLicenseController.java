...
import com.platform.springboot.service.dmi.DmiBusinessLicenseService;
...
public class DmiBusinessLicenseController {
    ...
    public Result handle(@RequestBody String requestJson) {
        log.info("新增/编辑营业执照信息-开始,入参:requestJson="+requestJson);
        Result result = dmiBusinessLicenseService.handle(requestJson);
    ...
    public Result handleInvalid(@RequestBody String requestJson) {
        log.info("失效营业执照-开始,入参:requestJson="+requestJson);
        Result result = dmiBusinessLicenseService.handleInvalid(requestJson);
    ...
    public Result handleDelete(@RequestBody String requestJson) {
        log.info("删除营业执照-开始,入参:requestJson="+requestJson);
        Result result = dmiBusinessLicenseService.handleDelete(requestJson);
