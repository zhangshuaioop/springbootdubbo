...
import com.platform.springboot.service.cfg.CfgFaultTypeModelService;
 ...
 * @Description: 故障类型
 * @date 2018/12/18下午3:01
 */
@RestController
@RequestMapping("/cfgFaultTypeModel")
@Api(description = "客服故障类型")
public class CfgFaultTypeModelController {
    ...
    @ApiOperation(value = "查询客服配置", httpMethod = "GET", notes = "查询客服配置")
    @RequestMapping(value = "/list", method = RequestMethod.GET)
    public Result list(@RequestParam String faultDefineType) {
        Result result = service.list(faultDefineType);
        log.info("查询客服配置-结束");
        return result;
    }
