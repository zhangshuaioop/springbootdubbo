...
public class PjtProjectController {
    ...
    public Result list(@RequestBody PjtProjectParam pjtProjectParam) {
        ...
        Result result = pjtProjectService.list(pjtProjectParam,CurrentUtil.getCurrent().getId());
