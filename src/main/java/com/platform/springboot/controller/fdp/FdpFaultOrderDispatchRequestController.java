...
import com.platform.springboot.entity.fdp.ParamFdpFaultDispatchRequestQuery;
import com.platform.springboot.service.fdp.FdpFaultOrderDispatchRequestService;
...
public class FdpFaultOrderDispatchRequestController {
    ...
    public Result uploadOrderExcel(@RequestParam("file") CommonsMultipartFile file) {
