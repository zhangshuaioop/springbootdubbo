...
public class RedisUtil {
        ...
        @PostConstruct
        public void init() {
            System.out.println("redis实例化成功");
            redisUtilService = this;
            redisUtilService.redisTemplate = this.redisTemplate;
        }


        public static RedisTemplate<Object,Object> getInstance() {
            return redisUtilService.redisTemplate;
        }
        /** 
...
     */
        public static void setForTimeMS(String key,String value,long time) {
            redisUtilService.redisTemplate.opsForValue().set(key, value, time, TimeUnit.MILLISECONDS);
        }
...
     */
        public static void setForTimeMIN(String key,String value,long time){
            redisUtilService.redisTemplate.opsForValue().set(key,value, time, TimeUnit.MINUTES);
        }
...
     */
        public static void setForTimeCustom(String key,String value,long time,TimeUnit type){
            redisUtilService.redisTemplate.opsForValue().set(key,value,time,type);
        }
...
     */
        public static String getAndSet(String key,String value){
            return (String) redisUtilService.redisTemplate.opsForValue().getAndSet(key,value);
        }
...
     */
        public static void batchSet(Map<String,String> keyAndValue){
            redisUtilService.redisTemplate.opsForValue().multiSet(keyAndValue);
        }
...
     */
        public static void batchSetIfAbsent(Map<String,String> keyAndValue){
            redisUtilService.redisTemplate.opsForValue().multiSetIfAbsent(keyAndValue);
        }
...
     */
        public static Long increment(String key,long number){
            return redisUtilService.redisTemplate.opsForValue().increment(key, number);
        }
...
     */
 ...
      */
        public static boolean expire(String key,long time,TimeUnit type){
            return redisUtilService.redisTemplate.boundValueOps(key).expire(time, type);
        }
...
     */
        public static boolean persist(String key){
            return redisUtilService.redisTemplate.boundValueOps(key).persist();
        }
...
     */
        public static Long getExpire(String key){
            return redisUtilService.redisTemplate.boundValueOps(key).getExpire();
        }
...
     */
        public static void rename(String key,String newKey){
            redisUtilService.redisTemplate.boundValueOps(key).rename(newKey);
        }
...
     */
        public static void delete(String key){
            redisUtilService.redisTemplate.delete(key);
        }
