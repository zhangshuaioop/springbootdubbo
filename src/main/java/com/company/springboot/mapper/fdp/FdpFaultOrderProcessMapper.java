...
public interface FdpFaultOrderProcessMapper {
    ...
    Page<GetFaultOrderList> queryFaultOrderListByObject(GetFaultOrderListRequest record);
     ...
     * @Date 2018/06/13
     */
    Page<GetFdpProcessDetailedList> getProcessListByObject(ParamFdpProcessDetailed param);


    Page<GetDemandCollectList> selectDemandList(ParamFdpProcessDetailed param);
    /**
     * 查询客服工单汇总
     * @param param
     * @return
     ...
     * @Date 2018/06/18
     */
    Page<GetBelongPersonCollerctList> selectDealPersonList(ParamFdpProcessDetailed param);
}