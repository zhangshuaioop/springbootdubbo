...
import com.company.springboot.entity.bif.BifDispatchHrAutonymValid;
import com.company.springboot.entity.bif.BifDispatchHumanResource;
import com.company.springboot.entity.bif.BifServiceListParam;
import com.company.springboot.entity.bif.DispatchHumanResourceList;
import com.company.springboot.service.bif.BifDispatchHumanResourceService;
...
public class BifDispatchHumanResourceController {
    ...
    public Result checkHrMobile(@RequestParam String mobile,@RequestParam String type) {
        log.info("校验服务商手机号-开始");
        Result result = service.checkHrMobile(mobile,type);
