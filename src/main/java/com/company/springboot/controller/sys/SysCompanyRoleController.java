...
import com.company.springboot.service.sys.SysCompanyRoleService;
...
public class SysCompanyRoleController {
    ...
    public Result saveOrUpdate(@RequestBody SysCompanyRole sysCompanyRole) {
        ...
        if(sysCompanyRole != null){
            ...
            if(sysCompanyRole.getId() != null && sysCompanyRole.getId() > 0){
                ...
                sysCompanyRolePermission.setRoleId(sysCompanyRole.getId());
                sysCompanyRolePermission.setPermissionIds("1");    //默认拥有首页权限
                sysCompanyRoleService.updateRolePermission(sysCompanyRolePermission);
            }
        }
    ...
    public Result findAllByUserId(@RequestParam Integer userId) {
        ...
        Result result = sysCompanyRoleService.findAllByUserId(userId);
