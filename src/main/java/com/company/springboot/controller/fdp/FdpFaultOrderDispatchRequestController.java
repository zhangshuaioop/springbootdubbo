...
import com.company.springboot.entity.fdp.ParamFdpFaultDispatchRequestQuery;
import com.company.springboot.service.fdp.FdpFaultOrderDispatchRequestService;
...
public class FdpFaultOrderDispatchRequestController {
    ...
    @ApiOperation(value = "导出雇主下所有门店信息", httpMethod = "GET", notes = "导出雇主下所有门店信息")
    ...
    @ApiOperation(value = "编辑预计服务时间", httpMethod = "GET")
    @GetMapping(value = "/editServiceTime")
    public Result editServiceTime(@RequestParam String estimatedServiceTime,@RequestParam Integer requestId) {
        log.info("编辑预计服务时间-开始");
        Result result = service.editServiceTime(estimatedServiceTime,requestId);
        log.info("编辑预计服务时间-结束");
        return result;
    }
