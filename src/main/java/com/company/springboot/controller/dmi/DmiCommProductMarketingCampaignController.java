...
import com.company.springboot.entity.dmi.ret.dmiCommProductMarketingCampaign.MarketingCampaignShowRet;
import com.company.springboot.entity.sys.SysCompanyUsers;
import com.company.springboot.service.dmi.DmiCommProductMarketingCampaignService;
import com.company.springboot.utils.CurrentUtil;
import com.company.springboot.utils.Result;
import com.company.springboot.utils.ResultUtil;
...
public class DmiCommProductMarketingCampaignController {
    ...
    @ApiOperation(value = "根据套餐ID，查询所有产品列表", httpMethod = "POST", notes = "根据套餐ID，查询所有产品列表")
    @RequestMapping(value = "/getProductListByPackageId", method = RequestMethod.POST)
    public Result getProductListByPackageId(@RequestBody DmiStoreCommProduct dmiStoreCommProduct) {
        logger.info("根据套餐ID，查询所有产品列表开始,入参:dmiStoreCommProduct="+dmiStoreCommProduct.toString());
        Result result = service.getProductListByPackageId(dmiStoreCommProduct);
    ...
    @RequestMapping(value = "/getIndependenceProductList", method = RequestMethod.POST)
    public Result getIndependenceProductList(@RequestBody DmiStoreCommProduct dmiStoreCommProduct) {
        logger.info("根据门店ID，查询所有独立产品列表开始,入参:dmiStoreCommProduct="+dmiStoreCommProduct.toString());
        Result result = service.getIndependenceProductList(dmiStoreCommProduct);
