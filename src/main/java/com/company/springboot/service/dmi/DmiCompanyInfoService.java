...
import com.company.springboot.mapper.sys.*;
...
public class DmiCompanyInfoService extends BaseService<DmiCompanyInfoMapper, DmiCompanyInfo> {
     ...
     * @return
     */
    public Result relieveCompany(Integer id){
        SysCompanyRelation sysCompanyRelation = new SysCompanyRelation();
        sysCompanyRelation.setEmpowerCompanyId(CurrentUtil.getCurrent().getCompanyId());
        sysCompanyRelation.setAuthorizedCompanyId(id);
        sysCompanyRelationMapper.deleteRelieveCompany(sysCompanyRelation);
                    ...
                    if(dmiCompanyInfoMapper.selectByCompanyName(dmiCompanyInfo.getCompanyName()) == null){
                        ...
                        while (isNext){
                            ...
                            if(sysCompanyUsersMapper.selectByUserName(username) == null){
                                ...
                                dmiOrganization.setOrganizationName("全公司");
    ...
    public Result companyListParam(Integer companyId){
        //查询关联公司
        List<DmiCompanyInfo> list=dmiCompanyInfoMapper.companyListParam(companyId);
        return ResultUtil.success(list);
    }
