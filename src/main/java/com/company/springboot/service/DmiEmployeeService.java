...
import com.company.springboot.Thread.ImportThread;
import com.company.springboot.entity.dmi.DmiEmployee;
import com.company.springboot.entity.dmi.DmiEmployeeExport;
import com.company.springboot.entity.dmi.DmiEmployeeUniqueness;
...
import com.company.springboot.service.dmi.DmiOrganizationService;
    ...
    public Result list(DmiEmployee dmiEmployee) {
        ...
        if(employee.size()>0) {
            if (dmiEmployee.getPageNum() != null & dmiEmployee.getPageSize() != null) {
                ...
                PageInfo<DmiEmployee> pageInfo = new PageInfo<>(employee);
