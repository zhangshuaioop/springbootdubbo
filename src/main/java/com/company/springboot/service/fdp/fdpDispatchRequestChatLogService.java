...
import com.company.springboot.entity.fdp.FdpDispatchRequestChatLog;
import com.company.springboot.entity.fdp.FdpFaultOrderProcess;
import com.company.springboot.entity.fdp.GetfdpDispatchRequestChatLogList;
import com.company.springboot.entity.sys.SysCompanyUsers;
import com.company.springboot.mapper.fdp.FdpDispatchRequestChatLogMapper;
...
/**
 * @author zhanghao
 * @Title: fdpDispatchRequestChatLogService
 * @ProjectName WaterDrop
 * @Description: 派工消息
 * @date 2018/12/22下午2:19
 */
@Service
