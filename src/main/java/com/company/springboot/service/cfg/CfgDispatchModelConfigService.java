...
import com.company.springboot.mapper.cfg.CfgDispatchModelConfigMapper;
...
public class CfgDispatchModelConfigService{
    ...
    public Result handle(CfgDispatchModelConfig cfgDispatchModelConfig) {
        ...
        if(cfgDispatchModelConfig.getSuggestPrice() == null || ValiDateUtil.isNumeric(cfgDispatchModelConfig.getSuggestPrice().toString()) == false){
