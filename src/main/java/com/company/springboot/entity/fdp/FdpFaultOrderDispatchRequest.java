...
public class FdpFaultOrderDispatchRequest {
    ...
    public String toString() {
        return "FdpFaultOrderDispatchRequest{" +
                "id=" + id +
                ", companyId=" + companyId +
                ", storeId=" + storeId +
                ...
                ", flagHasDispatched=" + flagHasDispatched +
                ...
                ", dispatchModelId=" + dispatchModelId +
                ", estimatedServiceTime=" + estimatedServiceTime +
                ", expectReplyHours=" + expectReplyHours +
                ", expectReplyTime=" + expectReplyTime +
                ", flagFuzzyAddress=" + flagFuzzyAddress +
                ...
                ", flagFixedPrice=" + flagFixedPrice +
                ", flagRequestModified=" + flagRequestModified +
                ", flagDraft=" + flagDraft +
                ...
                ", completeProfileTemplateUrl='" + completeProfileTemplateUrl + '\'' +
                ", completeProfileTemplateName='" + completeProfileTemplateName + '\'' +
                ", completeProfileTemplateUpdateTime=" + completeProfileTemplateUpdateTime +
                ", completeProfileTemplateUpdatePerson=" + completeProfileTemplateUpdatePerson +
                ", flagEmergency=" + flagEmergency +
                ", flagAutoCommit=" + flagAutoCommit +
                ", fileName='" + fileName + '\'' +
