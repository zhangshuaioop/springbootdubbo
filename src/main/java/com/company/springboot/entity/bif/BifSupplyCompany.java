...
public class BifSupplyCompany {
    ...
    private Integer demandCompanyId;
    ...
    public Integer getDemandCompanyId() {
        return demandCompanyId;
    }

    public void setDemandCompanyId(Integer demandCompanyId) {
