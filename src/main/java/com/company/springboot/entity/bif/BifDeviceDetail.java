...
public class BifDeviceDetail extends BaseEntity {
    ...
    public String toString() {
        return "BifDeviceDetail{" +
                ...
                ", deviceCompanyRelationId=" + deviceCompanyRelationId +
                ", childNode='" + childNode + '\'' +
                ", fatherNode='" + fatherNode + '\'' +
                ", grandFatherNode='" + grandFatherNode + '\'' +
                ", deviceStoreRelationId=" + deviceStoreRelationId +
                ", installDate=" + installDate +
                ", installDateMax=" + installDateMax +
                ", installDateMin=" + installDateMin +
                ", storeId=" + storeId +
                ", expireDate=" + expireDate +
                ", deviceCompanyRelationMemo='" + deviceCompanyRelationMemo + '\'' +
                ", deviceStoreRelationMemo='" + deviceStoreRelationMemo + '\'' +
