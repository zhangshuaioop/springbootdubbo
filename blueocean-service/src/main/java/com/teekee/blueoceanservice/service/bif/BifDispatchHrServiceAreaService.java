...
import com.teekee.blueoceanservice.mapper.bif.BifDispatchHrServiceAreaMapper;
...
public class BifDispatchHrServiceAreaService {
    ...
    public Result handle(BifDispatchHrServiceArea serviceArea) {
        ...
        if(serviceArea.getNation()==null || serviceArea.getNation().equals("")) return ResultUtil.validateError("国家不能为空");
        if(serviceArea.getProvince()==null || serviceArea.getProvince().equals("")) return ResultUtil.validateError("请填写省份！");
        if(serviceArea.getCity()==null || serviceArea.getCity().equals("")) return ResultUtil.validateError("请填写城市！");
    ...
    public Result serviceAreaList(BifDispatchHrServiceArea area) {
        if(area.getPageNum()!=null&& area.getPageSize()!=null){
            ...
            List<BifDispatchHrServiceArea> list = mapper.selectByHrId(area.getHrId());
