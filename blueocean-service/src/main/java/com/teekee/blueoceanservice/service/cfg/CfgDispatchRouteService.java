...
import com.teekee.blueoceanservice.entity.pjt.PjtProject;
...
import com.teekee.blueoceanservice.mapper.pjt.PjtProjectMapper;
...
public class CfgDispatchRouteService extends BaseService<CfgDispatchRouteMapper,CfgDispatchRoute> {
    ...
    public Result findPerson(Integer id){
        ...
        map.put("sysUsers",sysConsoleUsersMapper.findPage(sysConsoleUsers));
        map.put("cfgUsers",sysConsoleUsersMapper.selectByRouteCfg(ids));
    ...
    public Result findCompanyList(){
        ...
        return ResultUtil.success(dmiCompanyInfoMapper.findAll(dmiCompanyInfo));
    }
