...
//public boolean isFlagCustomerConfirm() {
    ...
    public String toString() {
        return "FdpFaultDispatchOrder{" +
                ...
                ", vendorId=" + vendorId +
                ", flagCustomerConfirm=" + flagCustomerConfirm +
                ", flagDispatcherConfirm=" + flagDispatcherConfirm +
                ", sendHrInfoConfirmTime=" + sendHrInfoConfirmTime +
                ", customerHrInfoConfirmTime=" + customerHrInfoConfirmTime +
                ", dispatcherFinalConfirmTime=" + dispatcherFinalConfirmTime +
                ", customerFinalConfirmTime=" + customerFinalConfirmTime +
