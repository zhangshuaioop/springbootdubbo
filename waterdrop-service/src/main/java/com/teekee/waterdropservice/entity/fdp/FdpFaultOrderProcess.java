...
public class FdpFaultOrderProcess {
    ...
    public String toString() {
        return "FdpFaultOrderProcess{" +
                ...
                ", telephone='" + telephone + '\'' +
                ", contactId=" + contactId +
                ", flagSimilarFault=" + flagSimilarFault +
                ", similarFaultId=" + similarFaultId +
                ...
                ", flagDispatchRequest=" + flagDispatchRequest +
                ", finalCost=" + finalCost +
                ", monetaryUnit='" + monetaryUnit + '\'' +
                ", sourceReportId=" + sourceReportId +
                ", sortId=" + sortId +
                ", rootId=" + rootId +
                ", flagFirstOrder=" + flagFirstOrder +
                ", flagHasMultiple=" + flagHasMultiple +
                ", createPerson=" + createPerson +
                ", createTime=" + createTime +
                ", updatePerson=" + updatePerson +
                ", updateTime=" + updateTime +
                ", flagUserAssm=" + flagUserAssm +
                ", flagClientAssm=" + flagClientAssm +
                ", faultInfoConfirmTime=" + faultInfoConfirmTime +
                ", otherFaultDevices='" + otherFaultDevices + '\'' +
                ", dealPersonId=" + dealPersonId +
                ", belongPersonId=" + belongPersonId +
                ", flagLastOrder=" + flagLastOrder +
                ", faultTypeModelId=" + faultTypeModelId +
                ", inputType='" + inputType + '\'' +
                ", Mobile='" + Mobile + '\'' +
