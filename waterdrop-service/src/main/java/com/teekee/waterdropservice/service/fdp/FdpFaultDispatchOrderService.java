...
import com.teekee.waterdropservice.entity.sys.ParamSysOperationMessage;
...
import com.teekee.waterdropservice.mapper.bif.BifDispatchHumanResourceMapper;
import com.teekee.waterdropservice.mapper.cfg.CfgDispatchWarningStatusMapper;
import com.teekee.waterdropservice.mapper.fdp.*;
import com.teekee.waterdropservice.mapper.sys.SysCompanyUsersMapper;
import com.teekee.waterdropservice.mapper.sys.SysOperationMessageMapper;
...
public class FdpFaultDispatchOrderService {
    ...
    public Result serOrderList(ParamServiceDispatchOrder param) {
        return ResultUtil.success(fdpFaultDispatchOrderMapper.selectServiceListByOrderId(param));
    }
