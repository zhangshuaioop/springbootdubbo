package com.teekee.messengerservice.entity.trc;
...
public class TrcEmailLog extends BaseEntity {
    ...
    @ApiModelProperty(value = "业务类型", example = "DISPATCH_GD", required = true)
    private String businessType;

    @ApiModelProperty(value = "状态0开始，1处理中，2成功", example = "1", required = true)
    private Integer status;

    @ApiModelProperty(value = "参数", example = "1", required = true)
