...
public class EmailService {
    ...
    public Result sendEmail(TrcEmailLog trcEmailLog){
        ...
        //设置模板
        if(trcEmailLog.getContext() == null || trcEmailLog.getContext().length() < 1 ||
                trcEmailLog.getNickName() == null || trcEmailLog.getNickName().length() < 1 ||
                trcEmailLog.getSubject() == null || trcEmailLog.getSubject().length() < 1){
